                ...
                data.forEach((item, index)=> {
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <img class="mt-3 rounded overflow-hidden" src="${base_url}/img/${item.gambar}" alt="">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <p><strong><?=rupiah(${item.harga_jual})?></strong></p>
                                </div>
                                <div class="col-2 col-sm-5">
                                <div class="container btn-jumlah d-flex justify-content-between">
                                    <div class="minus-fjs button">-</div>
                                    <span class="num-fjs">01</span>
                                    <input type='hidden' class="num" name='jumlah' value='1'> 
                                    <div class="plus-fjs button">+</div>
                                </div>
                                </div>
                            </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="pesan.." name='deskripsi'></textarea>
                    </div>
                    <br>
                    </div>
                        `);
